...
function Hero() {
  return (
    <div className='px-10 md:px-28 lg:px-44 xl:px-56 flex flex-col justify-center items-center mt-24'>
        ...
        <h2 className='font-extrabold text-5xl text-center' >AI-Powered <span className='text-[#FA812F]'>Email Templates</span></h2>
        ...
        <Image src={'/landing.png'} alt='landing-image' width={1000} height={800} className='mt-12 rounded-xl' />
