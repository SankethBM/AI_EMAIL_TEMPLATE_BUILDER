...
function ElementsSideBar() {
  ...
  return (
    <div className="p-5 h-screen shadow-sm">
      <h2 className="font-bold text-lg text-center">Layouts</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-3">
        {Layout.map((layout, index) => (
          <div
            key={index}
            draggable
            onDragStart={() => onDragLaoutStart(layout)}
          >
      ...
      <h2 className="font-bold text-lg text-center mt-6">Elements</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-3">
